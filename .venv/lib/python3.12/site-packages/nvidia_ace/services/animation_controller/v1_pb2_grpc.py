...
class AnimationControllerService(object):
    ...
    def RequestAnimationIds(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/nvidia_ace.services.animation_controller.v1.AnimationControllerService/RequestAnimationIds',
    ...
    def PullAnimationDataStream(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/nvidia_ace.services.animation_controller.v1.AnimationControllerService/PullAnimationDataStream',
    ...
    def PushAudioStream(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/nvidia_ace.services.animation_controller.v1.AnimationControllerService/PushAudioStream',
    ...
    def UpdateAnimationGraphVariable(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/nvidia_ace.services.animation_controller.v1.AnimationControllerService/UpdateAnimationGraphVariable',
